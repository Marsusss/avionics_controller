#define ARRAY_SIZE 3 // Change this to the number of elements you want
...
void loop() {
  int numbers[ARRAY_SIZE] = {1, 2, 3}; // Replace with your numbers
  ...
  delay(500); // Wait for a second before next iteration
}
